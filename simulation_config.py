...
class SimulationConfig:
    ...
    phase_space_track_gauge: bool = False
    ...
    lambda_obs: float            = 1  # External observations
    ...
    # =============================================================================
    lr_mu_q: float           = 0.1
    lr_sigma_q: float        = 0.025
    lr_mu_p: float           = 0.05
    lr_sigma_p: float        = 0.0125
    lr_phi: float            = 0.1
    ...
    hamiltonian_friction: float        = 0  # Damping coefficient γ (0 = conservative)
    hamiltonian_mass_scale: float      = 1  # Mass scale for kinetic term
    hamiltonian_include_gauge: bool    = False  # Include gauge field φ in phase space (full field theory)
